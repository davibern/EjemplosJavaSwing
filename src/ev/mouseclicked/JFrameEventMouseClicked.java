 ...
 * @version 1.0
 */
public class JFrameEventMouseClicked extends javax.swing.JFrame {

    /**
     * Creates new form JFrameEventMouseClicked
     */
    public JFrameEventMouseClicked() {
        initComponents();
    }
    ...
    private void formMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_formMouseClicked
        if (evt.getButton()== 1) {
            ...
            this.jPopupMenuEmergente.show(this, evt.getX(), evt.getY());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameEventMouseClicked.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameEventMouseClicked().setVisible(true);
            }
        });
    }
